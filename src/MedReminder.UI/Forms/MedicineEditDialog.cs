...
internal sealed class MedicineEditDialog : MedReminderFormBase
{
    ...
    //{
    //    base.OnLoad(e);
    //    // Seed the schedule editor once its controls are realized, so
    //    // an existing advanced regime (weekly, cyclic, tapering, PRN,
    //    // stepped) opens on its own values. A FixedDaily / null seed
    //    // leaves the panel in Simple mode, driven by the dose /
    //    // administrations fields above.
